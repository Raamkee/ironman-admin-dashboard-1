...
const Regions = () => {
  ...
  const loadAdmins = useCallback(async () => {
    ...
    try {
      const res = await fetch(
        `${import.meta.env.VITE_API_BASE_URL}/api/v1/crm/users/region-managers?search=${encodeURIComponent(
          search
  ...
  const modalTitle = modal.newStatus === 'active' ? 'Activate Hub Administrator' : 'Deactivate Region Administrator';
                ...
                {!admins.length ? (
                  <tr>
                    ...
                    >
                      ...
                      No region administrators found matching your criteria.
                    </td>
                  </tr>
                ) : (
                  admins.map((p, index) => (
